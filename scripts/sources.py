...
def search_antibody_complexes(max_hits: int = 50, sabdab_path: Path | None = None) -> list[str]:
    ...
    if len(valid_entries) < max_hits:
        log.warning(f"Trovati solo {len(valid_entries)} complessi umani/murini su {max_hits} richiesti")
